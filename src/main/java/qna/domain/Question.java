...
public class Question extends AbstractEntity {
    ...
    public DeleteHistories deleteQuestionAndAnswers(final User loginUser) throws CannotDeleteException {
        final DeleteHistories deleteHistories = DeleteHistories.of(delete(loginUser));
