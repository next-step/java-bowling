...
2. 프레임이 가지고 있어야 하는 메서드를 규정한 추상 클래스

3. 1~9프레임에 사용되는 일반 프레임

4. 10프레임에 사용되는 마지막 프레임

5. 프레임들을 한번에 관리할 수 있게 해주는 프레임 컬렉션

#### 핀

6. 핀들이 가지고 있어야 하는 메서드를 규정한 추상 클래스

7. 1~9프레임에 사용되는 일반 핀들

8. 10프레임에 사용되는 마지막 핀들

9. 핀

#### 기타

10. 프레임과 보너스포인트프레임을 담은 볼링 객체

11. 놀수 있는 속성을 담은 Playable 인터페이스
...
- 프레임이 종료되었을 경우 프레임을 변경할 수 있어야 한다
- 프레임들의 종료여부를 판단해줄 수 있어야 한다
- 프레임들의 점수반영 종료 여부를 반단해줄 수 있어야 한다
...
- 점수를 검증해야 한다
- 점수를 몇번 더할수 있는지 계산해야 한다

### 클래스 다이어그램
<img src="classDiagramAfterReview1.png"/>
