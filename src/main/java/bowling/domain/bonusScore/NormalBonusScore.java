...
public class NormalBonusScore implements BonusScore{
    ...
    public NormalBonusScore(int firstThrowScore, int secondThrowScore, boolean strikeBonus) {
    ...
    public static NormalBonusScore of(NumberOfHitPin firstHitPin, NumberOfHitPin secondHitPin) {
        if (firstHitPin == null && secondHitPin != null) {
            throw new InvalidBonusScoreArgumentException("첫 투구 없이 두번째 투구만 진행한 경우는 존재하지 않습니다.");
        }
        return new NormalBonusScore(
    ...
    public boolean equals(Object o) {
        ...
        NormalBonusScore that = (NormalBonusScore) o;
