...
public class FinalFrame extends Frame {
    ...
    public static final String MAX_FINAL_PITCH_COUNT_OVER = String.format("마지막 프레임은 최대 %s회까지 투구가 가능합니다.", BONUS_PITCH_COUNT);
    ...
    private void validatePinCount(int pinCount) {
        ...
        if ((getPitchCount() + 1) > BONUS_PITCH_COUNT) {
    ...
    private boolean isBonusPitchCount() {
        return getPitchCount() == BONUS_PITCH_COUNT;
    }
}
