...
import bowling.step3.domain.state.Ready;
import bowling.step3.domain.state.State;
...
public class NormalFrame extends Frame {
    ...
    public Score getScore() {
        ...
        return nextFrame.caculateAdditionalScore(score);
    }

    @Override
    public Score caculateAdditionalScore(Score beforeScore) {
