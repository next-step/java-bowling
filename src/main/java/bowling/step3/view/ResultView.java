...
import bowling.step3.dto.FrameDto;
import bowling.step3.dto.FramesDto;
import bowling.step3.dto.PinCountDto;
import bowling.step3.dto.ScoreDto;
...
public class ResultView {
    ...
    public static void printScoreBoard(String name, FramesDto framesDto) {
        System.out.println("| NAME |  01  |  02  |  03  |  04  |  05  |  06  |  07  |  08  |  09  |  10  |");
        printName(name);
        printPinCount(framesDto);
        printScore(framesDto);
    }
