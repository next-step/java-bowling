...
public class OutputView {
    ...
    public void printGame(Bowling bowling) {
        System.out.println(BOARD);

        StringBuilder frameStringBuilder = new StringBuilder();
        frameStringBuilder.append(nameStringBuilder(bowling.player()));
        frameStringBuilder.append(pinStringBuilder(bowling));
        ...
        scoresStringBuilder.append(scoreStringBuilder(bowling));
        System.out.println(scoresStringBuilder.toString());

        System.out.println();
    }

    private StringBuilder scoreStringBuilder(Bowling bowling) {
    ...
    private StringBuilder nameStringBuilder(Player player) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(LEFT_BOX_SINGLE_SPACE);
