...
//        first.playManual(5, frames);
//        assertThat(first.subtotal().value()).isZero();
//        first.playManual(4, frames);
...
//        Frames frames = Frames.create();
//        Frame first = frames.first();
//        first.playManual(1, frames);
//        first.playManual(9, frames);
