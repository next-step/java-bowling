...
public class QuestionTest {
    ...
    public void deleteTest1(){
        ...
        assertDoesNotThrow(() -> tempQ1.delete(UserTest.JAVAJIGI));
    }
    ...
    public void deleteTest2(){
        ...
        assertThrows(CannotDeleteException.class, () -> tempQ1.delete(UserTest.SANJIGI));
    }
    ...
    public void deleteTest4(){
        ...
        assertThrows(CannotDeleteException.class, () -> tempQ1.delete(UserTest.JAVAJIGI));
    }

    @Test
    @DisplayName("질문을 삭제했을 때 질문과 연관 답글의 상태가 삭제 상태인지 테스트")
    public void deleteTest5() throws CannotDeleteException {
        ...
        tempQ2.delete(UserTest.SANJIGI);
    ...
    public void deleteTest6() throws CannotDeleteException {
        Question tempQ2 = new Question("title2", "contents2").writeBy(UserTest.SANJIGI);
        Answer tempA2 = new Answer(UserTest.SANJIGI, tempQ2, "Answers Contents2");
        tempQ2.addAnswer(tempA2);

        assertThat(tempQ2.delete(UserTest.SANJIGI)).hasSize(2);
    }
