...
public class QuestionTest {
    ...
    @Test
    public void changeStatusOfDataTest() {
    ...
    @DisplayName("로그인_사용자와_질문한_사람이_같은_경우_삭제_가능하다")
    @Test
    public void deleteTestIfLoginUserIsEqualToQuestionerTest() {
    ...
    @DisplayName("답변이_없는_경우_삭제_가능하다")
    @Test
    public void deleteTestIfNoAnswerTest() {
    ...
    @DisplayName("질문자와_답변글의_모든_답변자가_같은_경우_삭제가_가능하다")
    @Test
    public void deleteTestIfQuestionerIsEqualToAllAnswerersTest() {
    ...
    @DisplayName("질문을_삭제할_때_답변_또한_삭제해야_하며_답변의_삭제_또한_삭제_상태_deleted로_변경한다")
    @Test
    public void mustChangeStatusAndDeleteQuestionAndAnswersTest() {
        question.addAnswer(answer1);
    ...
    @DisplayName("질문자와_답변자가_다른_경우_답변을_삭제할_수_없다")
    @Test
    public void cannotDeleteIfQuestionerIsDifferentFromAnswerer() {
    ...
    @DisplayName("질문과_답변_삭제_이력에_대한_정보를_DeleteHistory를_활용해_남긴다")
    @Test
