...
public class QuestionTest {
    ...
    @MethodSource("provideQuestionByGuestWithAnswers")
    @ParameterizedTest
    ...
    void deleteWithNoAnswers() throws CannotDeleteException {
        Question question = new Question("test", "test2").writeBy(User.GUEST_USER);
        List<DeleteHistory> deleteHistoryList = question.delete(User.GUEST_USER);
    ...
    void deleteWithEqualsAllAnswerUserException(Question question) {
        question.addAnswer(new Answer(UserTest.JAVAJIGI, question, "답변4"));
    ...
    private static Stream<Arguments> provideQuestionByGuestWithAnswers() {
        Question question = new Question("title2", "contents2").writeBy(User.GUEST_USER);
