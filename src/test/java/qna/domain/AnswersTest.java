...
class AnswersTest {
    ...
    void 모든_답변_삭제_성공() throws CannotDeleteException {
        ...
        assertAll(
                ...
                () -> assertThat(deleteHistories.get(0).getContentType()).isEqualTo(
                        ContentType.ANSWER),
                () -> assertThat(deleteHistories.get(0).getDeletedBy()).isEqualTo(
                        UserTest.JAVAJIGI),
                () -> assertThat(deleteHistories.get(1).getContentType()).isEqualTo(
                        ContentType.ANSWER),
