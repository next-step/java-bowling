...
public class FrameStateTest {
    ...
    void strike() {
        ...
        Assertions.assertThat(strike).isEqualTo(FrameState.STRIKE.frameState());
    }
    ...
    void gutter() {
        ...
        Assertions.assertThat(gutter).isEqualTo(FrameState.GUTTER.frameState());
    }
    ...
    void spare() {
        ...
        Assertions.assertThat(spare).isEqualTo(FrameState.SPARE.frameState());
    }
}
