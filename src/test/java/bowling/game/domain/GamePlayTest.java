...
class GamePlayTest {
    ...
    void rollCover() {
        GamePlay game = GamePlay.play(Arrays.asList("LJS", "JHJ"));
        game.roll(Pin.of(3));
        assertThat(game.getCurrentPlayer()).isEqualTo(Player.of("LJS"));
    }
    ...
    void rollSpare() {
        ...
        game.roll(Pin.of(3));
        game.roll(Pin.of(7));
        assertThat(game.getCurrentPlayer()).isEqualTo(Player.of("JHJ"));
    }
