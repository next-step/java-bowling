...
public class ReadyTest {
    ...
    void bowlToContinueTest() {
        ...
        assertThat(ready.stateAfterBowling(7)).isEqualTo(Continue.of(pins));
    }
    ...
    void bowlToStrikeTest() {
        ...
        assertThat(ready.stateAfterBowling(10)).isEqualTo(Strike.of(pins));
    }

    @ParameterizedTest(name = "넘어뜨린 핀 개수 예외 테스트")
    @ValueSource(ints = {11, -1, 15})
    void pinsCountExceptionTest(int pitch) {
        assertThatThrownBy(() -> ready.stateAfterBowling(pitch))
