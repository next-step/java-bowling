...
class PointTest {
    ...
    void firstPointInBoxedRange0to10(int input) {
        ...
        assertThat(point.point()).isEqualTo(input);
    }
    ...
    void pointNotInRangeThrowsException(int input) {
        CustomException customException = assertThrows(CustomException.class, () -> new Point(input));
    ...
    void verifiesFirstPointStrikeOrNot(int input, boolean didClear) {
        Point point = new Point(input);
        assertThat(point.didClear()).isEqualTo(didClear);
    }
    ...
    void verifiesSecondPoint(int curPoint, int prePoint) {
        Point point = new Point(curPoint, prePoint);
        assertThat(point.point()).isEqualTo(curPoint);
    }
    ...
    void secondPointNotInRangeThrowsException(int curPoint, int prePoint) {
        CustomException customException = assertThrows(CustomException.class, () ->  new Point(curPoint, prePoint));
        assertThat(customException.errorCode()).isEqualTo(ErrorCode.INVALID_POINT);
    }
