...
public class ScoreTest {
    ...
    void inputStrikeValueTest() {
        ...
        assertThat(score.updateScore(0)).isEqualTo("-");
    }
    ...
    void inputTwoTimes() {
        ...
        assertThat(score.updateScore(7)).isEqualTo("7");
        assertThat(score.updateScore(2)).isEqualTo("2");
    }
    ...
    void inputSpareTest() {
        ...
        assertThat(score.updateScore(2)).isEqualTo("/");
    }
