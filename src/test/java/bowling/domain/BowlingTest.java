...
class BowlingTest {
    ...
    @Test
    void bowl() {
        Bowling result = bowling().bowl(FallenPin.of(10));

        assertThat(result).isEqualTo(new Bowling(List.of(FallenPin.of(10))));
    }
    ...
    void isStrike(int fallenPinCount, boolean expected) {
        Bowling bowling = bowling().bowl(FallenPin.of(fallenPinCount));
    ...
    void isSpare(int fallenPinCount1, int fallenPinCount2, boolean expected) {
        Bowling bowling = bowling()
                .bowl(FallenPin.of(fallenPinCount1))
                .bowl(FallenPin.of(fallenPinCount2));
    ...
    void finished_whenStrike() {
        Bowling bowling = bowling().bowl(FallenPin.of(10));
    ...
    void notFinished_whenTriesNotDone() {
        Bowling bowling = bowling().bowl(FallenPin.of(1));
