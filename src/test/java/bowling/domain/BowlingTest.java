...
class BowlingTest {
    ...
    @Test
    void bowl() {
        Bowling result = bowling().bowl(FallenPins.of(10));

        assertThat(result).isEqualTo(new Bowling(List.of(FallenPins.of(10))));
    }
    ...
    void isStrike(int fallenPins, boolean expected) {
        Bowling bowling = bowling().bowl(FallenPins.of(fallenPins));
    ...
    void isSpare(int fallenPins1, int fallenPins2, boolean expected) {
        Bowling bowling = bowling()
                .bowl(FallenPins.of(fallenPins1))
                .bowl(FallenPins.of(fallenPins2));
    ...
    void finished_whenStrike() {
        Bowling bowling = bowling().bowl(FallenPins.of(10));
    ...
    void notFinished_whenTriesNotDone() {
        Bowling bowling = bowling().bowl(FallenPins.of(1));
