...
class InProgressScoreTest {
    ...
    @Test
    void init() {
        assertThat(InProgressScore.of(10, 2)).isInstanceOf(InProgressScore.class);
    }

    @DisplayName("계산중인 스코어는 계산이 불가능 하다")
    @Test
    void isCalculable() {
        InProgressScore inProgressScore = InProgressScore.of(10, 2);
    ...
    @Test
    void initException() {
        assertThatThrownBy(() -> InProgressScore.of(10, 3)).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void equals() {
        InProgressScore inProgressScore = InProgressScore.of(10, 2);
        InProgressScore anotherInProgressScore = InProgressScore.of(10, 2);
        InProgressScore theOtherInProgressScore = InProgressScore.of(10, 1);
    ...
    @Test
    void ofStrike() {
        assertThat(InProgressScore.ofStrike()).isEqualTo(InProgressScore.of(10, 2));
    }

    @DisplayName("스페어의 스코어는 점수가 10에 남은 횟수가 1이다")
    @Test
    void ofSpare() {
        assertThat(InProgressScore.ofSpare()).isEqualTo(InProgressScore.of(10, 1));
    }
}
