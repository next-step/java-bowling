...
public class ScoresTest {
	...
	public static Stream<Arguments> 게임_결과들의_모음() {
		Score TEN = Score.of(ScoreBound.MAXIMUM_SCORE_BOUND.getBound());
		Score FIVE = Score.of(5);
		Score ZERO = Score.of(ScoreBound.MINIMUM_SCORE_BOUND.getBound());
	...
	void 총_점수의_합을_구한다(int firstScore, int secondScore, int bonusScore) {
		...
		scores.playFirstHalf(Score.of(firstScore));
		scores.playSecondHalf(Score.of(secondScore));
		scores.playBonusHalf(Score.of(bonusScore));
