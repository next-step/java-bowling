...
public class StrikeTest {
    ...
    @Test
    public void isMiss() {
        assertThat(Strike.newInstance().isMiss())
                .isFalse();
    }
    ...
    @Test
    public void getDesc() {
        assertThat(Strike.newInstance().getDesc())
    ...
    @Test
    public void bowl() {
        assertThatThrownBy(() -> Strike.newInstance().bowl(PinCount.of(PinCount.MAX_COUNT)))
    ...
    public void isFinish() {
        assertThat(Strike.newInstance().isFinish())
                .isTrue();
    }
}
