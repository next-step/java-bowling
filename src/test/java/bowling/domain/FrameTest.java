...
public class FrameTest {
    ...
    void frameTest_scoringText_strike() {
        Frame frame = new NormalFrame(1, new Balls(10, 0));
    ...
    void frameTest_scoringText_spare_1_9() {
        Frame frame = new NormalFrame(1, new Balls(1, 9));
    ...
    void frameTest_scoringText_spare_2_8() {
        Frame frame = new NormalFrame(1, new Balls(2, 8));
    ...
    void frameTest_scoringText_Miss_1_2() {
        Frame frame = new NormalFrame(1, new Balls(1, 2));
    ...
    void frameTest_scoringText_Miss_4_5() {
        Frame frame = new NormalFrame(1, new Balls(4, 5));
    ...
    void frameTest_scoringText_gutter() {
        Frame frame = new NormalFrame(1, new Balls(0, 0));
    ...
    void frameTest_scoringText_gutter_1_0() {
        Frame frame = new NormalFrame(1, new Balls(1, 0));
    ...
    void frameTest_scoringText_gutter_0_2() {
        Frame frame = new NormalFrame(1, new Balls(0, 2));
    ...
    void bonus_frame_scoringText_spare_0_10_strike() {
        Frame frame = new FinalFrame(10, new Balls(0, 10, 10));
    ...
    void bonus_frame_scoringText_spare_3_7_strike() {
        Frame frame = new FinalFrame(10, new Balls(3, 7, 10));
    ...
    void bonus_frame_scoringText_spare_3_7_miss() {
        Frame frame = new FinalFrame(10, new Balls(3, 7, 1));
    ...
    void bonus_frame_scoringText_spare_3_7_gutter() {
        Frame frame = new FinalFrame(10, new Balls(3, 7, 0));
    ...
    void bonus_frame_scoringText_strike_strike() {
        Frame frame = new FinalFrame(10, new Balls(10, 0, 10));
    ...
    void bonus_frame_scoringText_strike_miss() {
        Frame frame = new FinalFrame(10, new Balls(10, 0, 2));
    ...
    void bonus_frame_scoringText_strike_gutter() {
        Frame frame = new FinalFrame(10, new Balls(10, 0, 0));
