...
public class PinNumbersTest {
    ...
    public static final PinNumbers PIN_NUMBERS_SPARE = new PinNumbers(Arrays.asList(FIVE_PIN_NUMBER, FIVE_PIN_NUMBER));
    public static final PinNumbers PIN_NUMBERS_NONE = new PinNumbers(Arrays.asList(FIVE_PIN_NUMBER, ZERO_PIN_NUMBER));
