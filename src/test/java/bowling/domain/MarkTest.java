...
public class MarkTest {
    ...
    @CsvSource(value = {"10, 10, X|X", "0, 10, -|/", "5, 5, 5|/", "10, 0, X|-", "1, 1, 1|1"})
    ...
    @CsvSource(value = {"10, 10, 10, X|X|X", "10, 1, 9, X|1|/", "10, 1, 8, X|1|8", "10, 1, 0, X|1|-", "1, 9, 10, 1|/|X", "1, 9, 1, 1|/|1", "1, 9, 0, 1|/|-", "10, 10, 0, X|X|-"})
