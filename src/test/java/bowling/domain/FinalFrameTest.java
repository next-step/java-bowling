...
public class FinalFrameTest {
    ...
    public void bowling_OneTimeStrike_ReturnNotFinish() {
        ...
        assertThat(frame.bowling(new Pin(10))).isEqualTo(FrameState.ofNotFinish(10));
    }
    ...
    public void bowling_TwoTimeSpare_ReturnBonus() {
        ...
        assertThat(frame.bowling(new Pin(5))).isEqualTo(FrameState.ofNotFinish(10));
    }
    ...
    public void bowling_TwoTimeMiss_ReturnFinish() {
        Frame frame = new FinalFrame();
        frame.bowling(new Pin(5));
        assertThat(frame.bowling(new Pin(3))).isEqualTo(FrameState.ofFinish());
    }
    ...
    public void bowling_AfterStrike_ReturnFinish() {
        ...
        assertThat(frame.bowling(new Pin(5))).isEqualTo(FrameState.ofFinish());
    }
