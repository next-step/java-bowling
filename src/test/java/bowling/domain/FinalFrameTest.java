...
public class FinalFrameTest {
    ...
    @Test
    void init() {
        finalFrame.addPinCount(PinCountTest.PIN_COUNT_1);
    ...
    @Test
    void error() {
        assertThatExceptionOfType(OutOfRangeArgumentException.class).isThrownBy(()->{
            finalFrame.addPinCount(PinCountTest.PIN_COUNT_8);
            finalFrame.addPinCount(PinCountTest.PIN_COUNT_3);
        });
    }
    ...
    void secondPinAfterStrike() {
        finalFrame.addPinCount(PinCountTest.PIN_COUNT_10);
        finalFrame.addPinCount(PinCountTest.PIN_COUNT_8);
    ...
    void getThirdOpportunityWhenSpare() {
        finalFrame.addPinCount(PinCountTest.PIN_COUNT_8);
        finalFrame.addPinCount(PinCountTest.PIN_COUNT_2);
