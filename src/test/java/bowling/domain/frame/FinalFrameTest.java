...
public class FinalFrameTest {
    ...
    void 스트라이크프레임() {
        ...
        assertThat(resultFrame).isEqualTo(FinalFrame.of(STRIKE_PIN, ONE_STRIKE_RESULTS));
    ...
    void 스트라이크아닌한번친프레임() {
        ...
        assertThat(resultFrame).isEqualTo(FinalFrame.of(THREE_HIT_PIN, THREE_HIT_RESULTS));
        assertThat(resultFrame.isFinished()).isFalse();
    ...
    void 스페어프레임() {
        ...
        assertThat(resultFrame).isEqualTo(FinalFrame.of(SPARE_PIN, ONE_SPARE_RESULTS));
        assertThat(resultFrame.isFinished()).isFalse();
        assertThat(resultFrame.totalScore()).isEqualTo(Score.of(10, 0));
    }
    ...
    void 거터프레임() {
        ...
        assertThat(resultFrame).isEqualTo(FinalFrame.of(GUTTER_PIN, GUTTER_RESULTS));
        assertThat(resultFrame.isFinished()).isFalse();
    ...
    void 미스프레임() {
        ...
        assertThat(resultFrame).isEqualTo(FinalFrame.of(MISS_PIN, MISS_RESULTS));
    ...
    void 더블스트라이크() {
        ...
        assertThat(resultFrame).isEqualTo(FinalFrame.of(SPARE_PIN, DOUBLE_STRIKE_RESULTS));
        assertThat(resultFrame.isFinished()).isFalse();
    ...
    void 스트라이크후_재투구() {
        ...
        assertThat(resultFrame).isEqualTo(FinalFrame.of(THIRD_THREE_HIT_PIN, STRIKE_THIRD_THREE_RESULTS));
        assertThat(resultFrame.isFinished()).isTrue();
