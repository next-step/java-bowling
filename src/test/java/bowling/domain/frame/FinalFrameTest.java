...
public class FinalFrameTest {
    ...
    public void 첫번째_시도후_다음시도를_할_수_있다() {
        ...
        frame = frame.next(2);
        //then
        assertThat(frame).isEqualTo(FinalFrame.of(FinalScore.first(10).withSecond(2), false, true));
    }
    ...
    public void 두번째_시도후_시도의_합이_10이상이면_세번째_시도를_할_수_있다(int first, int second) {
        ...
        assertThat(frame).isEqualTo(
                FinalFrame.of(FinalScore.first(first).withSecond(second).withThird(10), false, false));
    }
    ...
    public void 두번째_시도후_시도의_합이_10보다_작으면_세번째_시도를_할_수_없다(int first, int second) {
        ...
        //then
        assertThat(frame).isEqualTo(
                FinalFrame.of(FinalScore.first(first).withSecond(second), false, false));
    }
