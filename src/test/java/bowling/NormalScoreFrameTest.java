...
public class NormalScoreFrameTest {
    ...
    void bowlTest1() {
        ...
        ScoreFrame nextScoreFrame = normalScoreFrame.bowl(10);

        assertThat(nextScoreFrame).isInstanceOf(NormalScoreFrame.class);

        ScoreFrame nextNextScoreFrame = nextScoreFrame.bowl(10);
    ...
    void bowlTest2() {
        ...
        ScoreFrame nextScoreFrame2 = normalScoreFrame2.bowl(9).bowl(1);
        ...
        ScoreFrame nextScoreFrame3 = normalScoreFrame3.bowl(9).bowl(0);
    ...
    void bowlTest3() {
        NormalScoreFrame normalScoreFrame = new NormalScoreFrame(new Turn(1), FrameResult.MISS);
        ScoreFrame nextScoreFrame = normalScoreFrame.bowl(9);
