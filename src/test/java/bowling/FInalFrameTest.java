...
public class FInalFrameTest {
    ...
    void calculatePrevSpareFrame() {
        ...
        assertAll(
                () -> assertThat(frame.totalScore().getScore()).isEqualTo(19),
                () -> assertThat(finalFrame.totalScore().getScore()).isEqualTo(17));
    }
    ...
    void calculatePrevStrikeFrame() {
        ...
        FinalFrame finalFrame = (FinalFrame) nextFrame.nextFrame(10);
        finalFrame.calculateFrame();
        ...
        assertAll(
                () -> assertThat(frame.totalScore().getScore()).isEqualTo(30),
                () -> assertThat(nextFrame.totalScore().getScore()).isEqualTo(30),
                () -> assertThat(finalFrame.totalScore().getScore()).isEqualTo(27));
    }
