...
class PinsTest {
    ...
    void knockedDownPinUnderZeroOrOverTenExceptionTest(int knockedDownPin) {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new Pins(knockedDownPin))
    ...
    void isStrikeTest(){
        assertTrue(new Pins(10).isStrike());
    }
    ...
    void isSpareTest(int knockedDownPin1, int knockedDownPin2, boolean isSpare){
        assertThat(new Pins(knockedDownPin2).isSpare(new Pins(knockedDownPin1))).isEqualTo(isSpare);
    }
    ...
    void sumOverMaxPinCountThrowException(int knockedDownPin1, int knockedDownPin2){
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new Pins(knockedDownPin2).isSpare(new Pins(knockedDownPin1)))
