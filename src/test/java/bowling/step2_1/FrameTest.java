...
import bowling.step2_1.domain.frame.FinalFrame;
import bowling.step2_1.domain.frame.Frame;
import bowling.step2_1.domain.frame.NormalFrame;
...
public class FrameTest {
    ...
    void create_normal_last() {
        ...
        assertThat(normalFrame.next()).isEqualTo(new FinalFrame(10));
    }
