...
- FrameResults
    ...
    - [X] 최대 3개를 넘을 수 없다.
- Player
    - [X] 이름과 PlayerFrames, 현재 Frame을 속성으로 갖는다.
    - [X] 이름으로 객체를 생성할 수 있다.
    - [X] 초구를 던져서 볼링게임을 시작할 수 있다.
        - [X] 이미 초구를 굴린 참가자는 다시 초구를 굴릴 수 없다.
    - [X] 현재 상태를 계산할 수 있다.
    - [ ] 1 ~ 9 프레임을 진행할 수 있다.
        - [ ] 현재 프레임의 완료 여부를 확인할 수 있다.
        - [ ] 현재 프레임이 진행 중이면 현재 프레임을 진행할 수 있다.
            - [ ] 현재 프레임이 완료됐으면 예외가 발생한다.
        - [ ] 현재 프레임이 완료됐으면 다음 프레임을 진행할 수 있다.
            - [ ] 현재 프레임이 완료되지 않았으면 예외가 발생한다.
        - [ ] 9 프레임까지 완료됐으면 더이상 진행할 수 없다.
    - [ ] 10 프레임을 진행할 수 있다.
        - [ ] 9 프레임까지 완료된 상태에서만 진행할 수 있다.
        - [ ] 마지막 프레임이 완료될 때까지 진행 할 수 있다.
- PlayerFrames
