...
- FrameResults
    ...
    - [X] 최대 3개를 넘을 수 없다.
- Player
    - [ ] 이름과 PlayerFrames, 현재 Frame을 속성으로 갖는다.
    - [ ] 이름으로 객체를 생성할 수 있다.
    - [ ] 초구를 던져서 볼링게임을 시작할 수 있다.
    - [ ] 현재 상태를 계산할 수 있다.
    - [ ] 9 프레임까지 일반 투구로 진행할 수 있다.
        - [ ] 현재 프레임이 끝나지 않았다면 해당 프레임을 진행한다.
        - [ ] 현재 프레임이 마무리됐다면 다음 프레임을 진행한다.
        - [ ] 10프레임은 진행할 수 없다.
    - [ ] 10 프레임은 마지막 투구로 진행할 수 있다.
        - [ ] 10 프레임이 끝날때까지 해당 프레임을 진행한다.
        - [ ] 1 ~ 9 프레임은 진행할 수 없다.
- PlayerFrames
