...
### 구현결과 평가(아쉬운점)
- Frame#throwBall 이 꼭 Frame 을 리턴할 필요가 있었을까?
- Frame#getNextFrame 은 진짜 넥스트가 아닌경우가 있다
- LastFrame#getScoring 이 모호하다. 세번 공을 던질 수 있는데 두번만 던져도 상태가 나온다.
- Frame#isFinish 는 default false 이고 LastFrame 만 수행한다. 공간낭비.. GameService 에서 수행했어도 되었을 것.
