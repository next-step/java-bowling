...
- domain
  - [X] `State` 
    - 볼링 상태에 대한 전체 기능의 대한 추상 관리 객체
    - [X] `FirstBowl`
      - 첫번째 투구의 대한 관리 객체
    - [X] `Miss`
      - 볼링 결과가 Miss 인 상태 관리 객체
    - [X] `Ready`
      - 볼링 준비 상태 관리 객체
    - [X] `Spare`
      - 볼링 결과가 Spare 인 상태 관리 객체
    - [X] `Strike`
      - 볼링 결과가 Strike 인 상태 관리 객체
...
- domain
  - [X] `Finished`
    - 한 프레임에서 볼링 투구가 끝난 상황
  - [X] `Running`
    - 한 프레임에서 볼링 투구가 진행중인 상황
  - [X] `Player`
    - 한 플레이어의 볼링 결과 저장
  - [X] `Players`
    - 여러명의 플레이어 관리 객체
