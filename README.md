...
- Player
    ...
    - [ ] 투구해서 볼링 게임을 진행할 수 있다. (투구 후 현재 진행한 Frame의 상태를 확인할 수 있다.)
        - [ ] 1 ~ 9 프레임에서 스트라이크로 종료 시 다음 Frame의 투구를 진행할 수 있다.
        - [ ] 1 ~ 9 프레임에서 스트라이크가 아닌 경우 두번의 투구 후 다음 Frame을 진행 할 수 있다.
...
- FrameResult(interface)
    ...
    - [X] Normal
        ...
        - [ ] 상황에 맞는 현재 프레임 상태를 알려줄 수 있다.
            - [ ] 아직 진행중일 때(첫번째 투구만 진행됐을 때)의 상태를 알려줄 수 있다.
            - [ ] 완료됐을 때(두번째 투구까지 진행됐을 때)의 상태를 알려줄 수 있다.
    - [ ] Final
...
- FrameStatus
    ...
    - [ ] 위의 기능들을 NumberOfHitPin을 전달받아서 처리하도록 리팩토링
