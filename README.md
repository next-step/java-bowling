...
- FrameResult(interface)
    ...
    - [ ] Strike
    - [ ] Normal
        - [ ] 첫번째 맞춘 핀의 수를 입력받아서 객체를 생성할 수 있다.
            - [ ] 첫번째 맞춘 핀의 수는 0 ~ 9 사이의 값을 갖는다.
        - [ ] 두번째 맞춘 핀의 수를 입력받을 수 있다.
            - [ ] 첫번째 맞춘 핀의 수와 두번째 맞춘 핀의 수의 합이 10을 넘을 수 없다.
- FrameResultFactory
    - [ ] 각 프레임의 첫번째 투구로 맞춘 핀의 수를 입력받아서 FrameResult를 생성할 수 있다.
- ThrowResult
...
- ThrowResults (폐기)
    - 요구사항 재분석 결과 스트라이크 외에는 던질때마다 결과를 출력해야 함.
